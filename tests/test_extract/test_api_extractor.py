...
class TestAPIExtractor:
    ...
    def test_initialization(self):
        ...
        assert extractor.name == "api_extractor"
        assert extractor.url == "https://api.test.com/data"
        assert extractor.headers == {"Authorization": "Bearer token"}
        assert extractor.params == {"limit": 100}
    
    def test_validate_valid_data(self):
        """Test validation with valid data."""
        extractor = APIExtractor("https://api.test.com/data")
